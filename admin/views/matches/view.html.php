...
/**
 * NuLiga match list view.
 *
 * @package     Joomla.Administrator
 * @subpackage  com_nuliga
 * @since  0.0.42
 */
class NuLigaViewMatches extends JViewLegacy
{
    /**
     * Displays the NuLiga match list view.
     *
    ...
    function display($tpl = null)
    {
        ...
        $context = "nuliga.list.admin.match";
    ...
    {
        JToolbarHelper::title(JText::_('COM_NULIGA_MANAGER_MATCHES'), 'match');
    }
}
